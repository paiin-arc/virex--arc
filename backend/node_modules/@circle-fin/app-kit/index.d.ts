...
declare class BridgeKit<TExtraProviders extends FlexibleBridgingProvider[] = []> {
     ...
     * ```
     */
    setCustomFeePolicy(customFeePolicy: CustomFeePolicy$1): void;
    /**
...
interface AppKitContext {
     ...
     *
     * @typeParam T - The operation type extending OperationType ('bridge' | 'swap')
     ...
     *
     * // Generic usage
     * function estimateFee<T extends OperationType>(
     *   operation: T,
     ...
     * ```
     */
    getFee?<T extends OperationType>(type: T, params: OperationParamsMap[T]): Promise<string>;
    /**
     ...
     *
     * @typeParam T - The operation type extending OperationType
     ...
     * ```
     */
    getFeeRecipient?<T extends OperationType>(type: T, info: {
        chain: ChainDefinition;
        params: OperationParamsMap[T];
    }): Promise<string>;
    /**
 ...
 */
type PrefixActions<Prefix extends string, Actions extends Record<string, unknown>> = {
...
/**
 * Union of all AppKit action names (currently only bridge actions).
 */
type AppKitActionName = keyof AppKitBridgeActions;
/**
...
declare class AppKit {
     ...
     *
     * Subscribe to events emitted during bridge operations. All bridge events
     * are prefixed with 'bridge.' (e.g., 'bridge.approve', 'bridge.burn') to
     ...
     *
     * @typeParam K - The action name to listen for
     * @param action - The action name (prefixed with 'bridge.') or '*' for all actions
     * @param handler - Callback function to invoke when the action occurs
     *
     * @example
     * ```typescript
