...
The Bridge Kit supports chains through Circle's Cross-Chain Transfer Protocol v2 (CCTPv2), enabling **800 total bridge routes** across networks:

### Mainnet Chains (20 chains = 380 routes)
...
### Testnet Chains (21 chains = 420 routes)
